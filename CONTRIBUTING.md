...
Fixes and minor improvements are always appreciated. If you would like to make
a larger contribution (for example, adding a new algorithm or a new set of 
features), please contact the developers first.
